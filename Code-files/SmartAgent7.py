...
from Faulty_Agent7 import FaultyAgent7
from simulators import smart_simulator_for_faulty_drone


class SmartAgent7(FaultyAgent7):
    '''
    ...
    def update_predator_beliefs(self, knowledge_node, is_predator_present, is_survey_knowledge):
        ...
        #             probs[node] = 0. + (1 - 0.95) * 1.
        #         else:
        #             probs[node] = 0.95 * (probs[node] / (1 - pr_knowledge_node))
...
if __name__ == "__main__":
    ...
    for steps_allowed in range(50, 301, 50):
        result = experiment(SmartAgent7, num_graphs=30, simulation_per_graph=100,
    ...
    # with open('smart_agent7.pkl', 'wb') as f:
